...
exports.post_verificar_reserva_v2 = (req, res, next) =>{
        ...
        if(cursoDoc.numeroDia==5 && !(estudianteDoc.cursosAsistidos.length>=2)){
            ...
            for(var i in estudianteDoc.cursosInscritos){
                ...
                if(cursoDoc._id+""==estudianteDoc.cursosInscritos[i]._id+""){
                    ...
                    if(cursoDoc.hora==estudianteDoc.cursosInscritos[i].hora && 
            ...
            else if(parseInt(cursoDoc.inscritos.length) < parseInt(cursoDoc.cupo)){
                if(!horarioOcupado){
